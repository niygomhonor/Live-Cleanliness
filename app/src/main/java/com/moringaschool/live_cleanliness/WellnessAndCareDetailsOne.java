...
public class WellnessAndCareDetailsOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wellness_and_care_details_one);
        ...
        mDatabaseRef= FirebaseDatabase.getInstance().getReference("Wellness and Care").child("WellnessRequest");
